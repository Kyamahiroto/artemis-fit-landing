...
export const Privacy = () => (
    ...
    >
        <p>A sua privacidade é uma prioridade para a Artemis Fit App. Esta política detalha como coletamos, usamos e protegemos as suas informações ao utilizar o nosso sistema de performance feminina inteligente.</p>
