...
export const Cookies = () => (
    ...
    >
        ...
        <p>Você pode configurar o seu navegador para recusar cookies. No entanto, lembre-se de que muitas funcionalidades cruciais da Artemis Fit App podem não funcionar corretamente sem eles.</p>
    </LegalLayout>
);
