...
const QuizSection: React.FC = () => {
  ...
  const getPersonalizedTip = () => {
    ...
    const tips: Record<string, string> = {
      consistency: 'Consistência vem de sistemas, não de motivação. O Artemis Fit App cria rotinas automáticas que se adaptam à SUA vida e ao seu ciclo.',
      ...
      <AnimatePresence mode="wait">
        {!isDone ? (
          ...
          >
            ...
            >
              <Zap size={18} /> Experimentar o Artemis Fit App Agora
            </a>
          </motion.div>
        )}
      </AnimatePresence>
...
export const InteractiveGuide = () => {
  ...
  return (
    <div className="min-h-screen bg-dark text-white font-sans selection:bg-primary selection:text-dark">
      <SEOHead
        title="Guia Interativo de Treino e Ciclo Menstrual | Artemis Fit App"
      ...
      <section className="pt-32 pb-20 px-6 text-center relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/30 text-primary text-xs font-bold uppercase tracking-widest mb-6">
            <Sparkles size={12} /> Guia Exclusivo Artemis Fit App
          </div>
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <div className="relative p-10 md:p-14 rounded-[2.5rem] border border-primary/20 bg-dark-surface text-center overflow-hidden">
              ...
              <p className="text-white/50 max-w-lg mx-auto mb-8">
                O Artemis Fit App automatiza toda essa ciência para você em tempo real, todos os dias, com inteligência artificial.
              </p>
              ...
              >
                <Zap size={22} /> Testar o Artemis Fit App Grátis
              </a>
      ...
      <footer className="py-10 px-6 text-center text-white/20 text-xs border-t border-white/5">
        <p>© {new Date().getFullYear()} Artemis Fit App. Todos os direitos reservados.</p>
