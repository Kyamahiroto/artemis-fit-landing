  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 transition-all duration-300 ${scrolled ? 'py-3 bg-dark/95 backdrop-blur-lg border-b border-white/10' : 'py-6 bg-dark/80 backdrop-blur-md border-b border-white/5'} md:px-12`}>
      ...
      <div className="hidden md:flex items-center gap-8 text-sm font-medium text-white/60">
        ...
        <a href="/ferramentas" className="hover:text-primary transition-colors flex items-center gap-1"><Sparkles size={14} /> Tools Free</a>
      ...
      <div className="grid md:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <ul className="space-y-4 text-white/40 text-sm">
            ...
            <li><a href="/ferramentas" className="hover:text-primary transition-colors text-primary flex items-center gap-2"><Sparkles size={14} className="text-primary" /> Ferramentas Livres</a></li>
          </ul>
        </div>
        <div>
