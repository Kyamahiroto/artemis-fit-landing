...
export const GuideReader = () => {
  ...
  // Execute any <script> blocks embedded in the guide content
  // This allows interactive quizzes and onclick handlers to work
  useEffect(() => {
    ...
    while ((match = scriptRegex.exec(guide.content)) !== null) {
